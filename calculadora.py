...
def calculate():
    ...
    modulos=['math.tan', 'math.sin', 'math.cos', 'math.sqrt', 'math.log', 'math.log10', 'math.e', 'math.pow', 'math.pi', 'math.radia']
...
b_12 = Button(frame_cientifica, text="pi", width=6, height=1, bg=co10, fg=fundo, font=('Ivy 10 bold'), relief=RAISED, overrelief=RIDGE, command=lambda:entering_values('12'))
b_12.place(x=0, y=58)

b_13 = Button(frame_cientifica, text=",", width=6, height=1, bg=co10, fg=fundo, font=('Ivy 10 bold'), relief=RAISED, overrelief=RIDGE, command=lambda:entering_values('13'))
